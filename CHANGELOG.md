...
- Tear down real ENet integration fixtures in engine ownership order by unregistering custom SceneTree multiplayer roots before closing peers and freeing replicated nodes, eliminating duplicate `tree_exited` cleanup diagnostics on Godot 4.4-4.7.
