...
- Restore the fault-safe backend to the commercial 10% performance contract without relaxing a threshold: the rebuilt official Godot 4.7.1 Universal 2 differential passes behavior, startup, fixed-frame, and all 13 families; the local candidate measures Dictionary 17.72% and String 8.50% faster than GDScript after the effect-aware polling change.
