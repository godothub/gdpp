...
// below GDPP's ignored export-worker directory, excludes compiler/package caches, follows project
// symlinks into private copies, and never hard-links customer files.
