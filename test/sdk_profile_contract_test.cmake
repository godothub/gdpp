...
set(GDPP_TEST_NINJA_VERSION_FILE
    "${GDPP_TEST_ADDON_DIR}/tools/NINJA-VERSION.txt")
file(READ "${GDPP_TEST_NINJA_VERSION_FILE}" GDPP_TEST_NINJA_VERSION_HEX HEX)
string(HEX
    "Ninja 1.13.2\ncommit 3441b633c2fe2c494e958780ba0f4227b1327634\n"
    GDPP_TEST_EXPECTED_NINJA_VERSION_HEX)
if(NOT GDPP_TEST_NINJA_VERSION_HEX STREQUAL
        GDPP_TEST_EXPECTED_NINJA_VERSION_HEX)
    message(FATAL_ERROR
        "Packaged Ninja version evidence must be exact UTF-8 text with Unix line endings")
endif()
